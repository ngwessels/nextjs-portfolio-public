  ...
  render() {
    return (
      <>
        <div
          className="container"
          style={{ width: "90%", maxWidth: 400, marginBottom: 40 }}
        >
          <a href="/Resume.pdf" className="button resume-download" download={"Resume"}>
            <ul>
              <li>&#68;ownload Resume</li>
              <li>&#68;ownloading Resume</li>
              <li>Open File</li>
            </ul>
        ...
        <style jsx>{`
          .button {
            ...
            &.resume-download {
              ...
              --rectangle: linear-gradient(135deg, #4a9a97 0%, #1f7a85 100%);
              --arrow: #ffffff;
              --text: #ffffff;
              --success: linear-gradient(135deg, #4CAF50 0%, #45a049 100%);
              --shadow: rgba(100, 178, 177, 0.3);
              ...
              & > div {
                ...
                &:after {
                  animation: background calc(var(--duration) * 1ms) linear
                    forwards calc(var(--duration) * 0.065ms);
                }
                svg {
